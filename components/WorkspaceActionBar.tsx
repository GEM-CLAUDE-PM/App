...
const ACTIONS: WorkspaceAction[] = [
  ...
  // ── NHÓM F — HSE ──────────────────────────────────────────────────────────
  { id:'HSE_INCIDENT',           code:'F1', label:'Báo cáo sự cố / Near Miss',  shortLabel:'Báo cáo sự cố',icon:<AlertTriangle size={13}/>,  group:'hse',       groupLabel:'An toàn HSE',    color:'orange',  tabId:'manpower',  subTab:'hse',      minLevel:1, domains:[],                    actionLabel:'Báo cáo ngay'     },
  { id:'PERMIT_TO_WORK',         code:'F2', label:'Giấy phép làm việc nguy hiểm',shortLabel:'PTW',         icon:<Wrench size={13}/>,            group:'hse',       groupLabel:'An toàn HSE',    color:'orange',  tabId:'manpower',  subTab:'hse',      minLevel:2, domains:['hse','site','cross'], actionLabel:'Xin phép PTW'     },
  { id:'HSE_INSPECTION',         code:'F4', label:'Kiểm tra an toàn định kỳ',   shortLabel:'HSE kiểm tra',icon:<Shield size={13}/>,           group:'hse',       groupLabel:'An toàn HSE',    color:'orange',  tabId:'manpower',  subTab:'hse',      minLevel:2, domains:['hse','site','cross'], actionLabel:'Kiểm tra AT'      },
  { id:'CAPA',                   code:'F5', label:'Corrective & Preventive Action',shortLabel:'CAPA',     icon:<CheckCircle2 size={13}/>,    group:'hse',       groupLabel:'An toàn HSE',    color:'orange',  tabId:'manpower',  subTab:'hse',      minLevel:2, domains:['hse','qaqc','cross'], actionLabel:'Lập CAPA'         },
